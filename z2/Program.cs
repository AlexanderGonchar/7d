...
int[] IndexesOfMinElementArray(int[,] matr)
{
...
PrintArray(matrix);
Console.WriteLine($"Индексы минимального элемента: строка = {IndexesOfMinElementArray(matrix)[0] + 1} " + $"столбец = {IndexesOfMinElementArray(matrix)[1] + 1}");
...
PrintArray(DeleteRowAndColumn(matr: matrix,
                              row: IndexesOfMinElementArray(matrix)[0],
                              column: IndexesOfMinElementArray(matrix)[1]));
